...
open class RoundedBarRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    internal let barCornerRadius = CGFloat(4.0)
    ...
    @objc public init(dataProvider: BarChartDataProvider, animator: Animator, viewPortHandler: ViewPortHandler, barCornerRadius: CGFloat)
    {
